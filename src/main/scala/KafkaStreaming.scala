...
object KafkaStreaming {
  ...
  def createKafkaStream(ssc: StreamingContext, kafkaProps: MessageHubCOnfig, topic: String): ReceiverInputDStream ={
    return ssc.createKafkaStream[String, String, StringDeserializer, StringDeserializer](
      kafkaProps,
      List(topic));
  }
}
